...
# reading csv file 
with open('tsne_3d_plot.csv', 'r') as csvfile: 
...
for i in rows:
    if i[4]=='0':
        r1.append([i[0],i[1],i[2],i[3]])
    elif i[4]=='1':
        r2.append([i[0],i[1],i[2],i[3]])
    elif i[4]=='2':
        r3.append([i[0],i[1],i[2],i[3]])
    elif i[4]=='3':
        r4.append([i[0],i[1],i[2],i[3]])
    elif i[4]=='4':
        r5.append([i[0],i[1],i[2],i[3]])
...
with open('new3d.csv', 'w') as file:
    writer = csv.writer(file)
    writer.writerow(["x1", "y1", "z1", "f1", "x2", "y2", "z2", "f2", "x3", "y3", "z3", "f3", "x4", "y4", "z4", "f4", "x5", "y5", "z5", "f5"])
    for r in newrow: 
        writer.writerow(r)
